...
data class ComposeUserStats(
    ...
    @Serializable
    data class Subject(
        @SerialName("1") val book: ComposeCollectionInfo = ComposeCollectionInfo.Empty,
        @SerialName("2") val anime: ComposeCollectionInfo = ComposeCollectionInfo.Empty,
        @SerialName("3") val music: ComposeCollectionInfo = ComposeCollectionInfo.Empty,
        @SerialName("4") val game: ComposeCollectionInfo = ComposeCollectionInfo.Empty,
        @SerialName("6") val real: ComposeCollectionInfo = ComposeCollectionInfo.Empty,
    ) {
