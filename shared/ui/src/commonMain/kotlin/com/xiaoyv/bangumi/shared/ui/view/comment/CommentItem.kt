...
@Composable
private fun ComposeReplyItemHeader(
    item: ComposeReply,
    level: Int,
    modifier: Modifier = Modifier,
    onClickUser: (String) -> Unit = {}
...
@Preview
@Composable
fun CommentReplyItemPreview() {
    PreviewColumn {
        CompositionLocalProvider(LocalCommentTargetAuthorUsername provides "tiny") {
            CommentReplyItem(
                item = PreviewComposeReply,
                level = 0
            )
        }
        CommentReplyItem(
