 ...
 */
            ...
            public:
                ...
                void AppendKey(_KeyT &key) {
                    ...
                    CSM_PLACEMENT_NEW(addr)
                    csmPair<_KeyT, _ValT>(key); //placement new
                ...
                const _ValT &operator[](_KeyT key) const {
                    ...
                    if (found >= 0) {
                        ...
                        if (!_dummyValuePtr) _dummyValuePtr = CSM_NEW
                        _ValT();
                ...
                void Copy(const csmMap &c) {
                    ...
                    for (csmInt32 i = 0; i < _size; ++i) {
                        CSM_PLACEMENT_NEW(&_keyValues[i])
                        csmPair<_KeyT, _ValT>(c._keyValues[i].First,
