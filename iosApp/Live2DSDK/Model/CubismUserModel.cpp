    ...
    namespace Cubism {
        namespace Framework {
            ...
            void CubismUserModel::LoadModel(const csmByte *buffer, csmSizeInt size, csmBool shouldCheckMocConsistency) {
                ...
                _modelMatrix = CSM_NEW
                CubismModelMatrix(_model->GetCanvasWidth(), _model->GetCanvasHeight());
