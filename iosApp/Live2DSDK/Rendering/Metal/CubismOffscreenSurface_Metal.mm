        ...
        namespace Framework {
            namespace Rendering {
                ...
                CubismOffscreenSurface_Metal::CubismOffscreenSurface_Metal()
                        : _colorBuffer(NULL), _renderPassDescriptor(NULL), _bufferWidth(0),
                          _bufferHeight(0), _pixelFormat(MTLPixelFormatRGBA8Unorm),
                          _clearColorR(1.0f), _clearColorG(1.0f), _clearColorB(1.0f),
                          _clearColorA(1.0f) {
                }

                csmBool CubismOffscreenSurface_Metal::CreateOffscreenSurface(
                    ...
                    do {
                        if (colorBuffer == NULL) {
                            ...
                            _renderPassDescriptor.colorAttachments[0].clearColor =
                                    MTLClearColorMake(_clearColorR, _clearColorG, _clearColorB,
                                            _clearColorA);

                            _renderPassDescriptor.depthAttachment.loadAction =
                                    MTLLoadActionClear;
                        ...
                        if (_colorBuffer) {
                            ...
                            _viewPort = {0.0f,
                                    0.0f,
                                    static_cast<double>(_colorBuffer.width),
                                    static_cast<double>(_colorBuffer.height),
                                    0.0,
                                    1.0};
                        } else {
                            _viewPort = {0.0,
                                    0.0,
                                    static_cast<double>(_bufferWidth),
                                    static_cast<double>(_bufferHeight),
                                    0.0,
                                    1.0};
                        }
                ...
                void CubismOffscreenSurface_Metal::SetClearColor(float r, float g, float b,
                        float a) {
                    _clearColorR = r;
                    _clearColorG = g;
                    _clearColorB = b;
                ...
                CubismOffscreenSurface_Metal::GetRenderPassDescriptor() const {
                    return _renderPassDescriptor;
                }

                void CubismOffscreenSurface_Metal::SetMTLPixelFormat(
