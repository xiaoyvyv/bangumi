        ...
        namespace Framework {
            namespace Rendering {
                CubismCommandBuffer_Metal::DrawCommandBuffer::DrawCommand::DrawCommand()
                        : _mtlCommandBuffer(NULL), _pipelineState(NULL),
                ...
                id <MTLCommandBuffer> CubismCommandBuffer_Metal::DrawCommandBuffer::DrawCommand::
                GetMTLCommandBuffer() {
                    return _mtlCommandBuffer;
                }

                void CubismCommandBuffer_Metal::DrawCommandBuffer::DrawCommand::
                SetMTLCommandBuffer(id <MTLCommandBuffer> commandBuffer) {
                    _mtlCommandBuffer = commandBuffer;
                }

                id <MTLRenderPipelineState> CubismCommandBuffer_Metal::DrawCommandBuffer::
                DrawCommand::GetRenderPipelineState() {
                ...
                CubismCommandBuffer_Metal::DrawCommandBuffer::DrawCommandBuffer()
                        : _vbStride(0), _vbCount(0), _ibCount(0), _vertices(NULL), _uvs(NULL),
                          _indices(NULL) {
                }
                ...
                void CubismCommandBuffer_Metal::DrawCommandBuffer::CreateVertexBuffer(
                        id <MTLDevice> device, csmSizeInt stride, csmSizeInt count) {
                    _vbStride = stride;
                    _vbCount = count;
                ...
                void CubismCommandBuffer_Metal::DrawCommandBuffer::CreateIndexBuffer(
                        id <MTLDevice> device, csmSizeInt count) {
                    _ibCount = count;
                    _indices = [device newBufferWithLength:sizeof(csmInt16) * _ibCount
                                                   options:MTLResourceStorageModeShared];
                }

                void CubismCommandBuffer_Metal::DrawCommandBuffer::UpdateVertexBuffer(
                        void *data, void *uvData, csmSizeInt count) {
                    csmSizeInt length = count * _vbStride;
                    csmFloat32 *destVertices =
                            reinterpret_cast<csmFloat32 *>([_vertices contents]);
                ...
                void CubismCommandBuffer_Metal::DrawCommandBuffer::UpdateIndexBuffer(
                        void *data, csmSizeInt count) {
                ...
                CubismCommandBuffer_Metal::DrawCommandBuffer::DrawCommand *
                CubismCommandBuffer_Metal::DrawCommandBuffer::GetCommandDraw() {
                    return &_drawCommandDraw;
                }

                void CubismCommandBuffer_Metal::DrawCommandBuffer::SetCommandBuffer(
