...
include(":composeApp")
include(":shared:core")
include(":shared:core-native")
include(":shared:core-resource")
include(":shared:data")
include(":shared:data-workflow")
include(":shared:ui")
include(":shared:ui-platform")
include(":shared:ui-video")
...
include(":features:main-tab:home")
include(":features:main-tab:profile")
include(":features:main-tab:timeline")
include(":features:main-tab:rakuen")
include(":features:main-tab:tracking")
include(":features:main-tab:newest")
...
include(":features:preview:video")
include(":features:pixiv:main")
include(":features:pixiv:illust:main")
include(":features:pixiv:illust:page")
include(":features:pixiv:tag:main")
include(":features:pixiv:login")
include(":features:pixiv:user:main")
include(":features:pixiv:user:setting")
include(":features:pixiv:user:edit")
